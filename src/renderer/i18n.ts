...
export const translations = {
  zh: {
    ...
    restoreConfirm: "恢复确认",
    autoApprovalBanner: "后续命令请求已自动允许，直到手动恢复确认。",
    permissionMode: "权限模式",
  ...
  en: {
    ...
    testing: "Testing...",
    testApi: "Test API",
    importCodexConfig: "Import Codex Config",
    ...
    emptyBody: "Pick a workspace, then begin.",
    you: "You",
    agent: "Agent",
    ...
    autoApprovalBanner: "Future command requests are automatically allowed until confirmation is restored.",
